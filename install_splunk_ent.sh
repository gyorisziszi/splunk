...
DEST_DIR="/tmp"
FILE_NAME="splunk-10.2.2-80b90d638de6.x86_64.rpm"
FULL_PATH="$DEST_DIR/$FILE_NAME"
URL="https://download.splunk.com/products/splunk/releases/10.2.2/linux/splunk-10.2.2-80b90d638de6.x86_64.rpm"
