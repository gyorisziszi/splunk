...
DEST_DIR="/tmp"
FILE_NAME="splunk-10.4.0-f798d4d49089.x86_64.rpm"
FULL_PATH="$DEST_DIR/$FILE_NAME"
URL="https://download.splunk.com/products/splunk/releases/10.4.0/linux/splunk-10.4.0-f798d4d49089.x86_64.rpm"
